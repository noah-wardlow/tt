/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: dc6bdf17cad909db7ef92e723ba886b5)
// Runtime types generated with workerd@1.20260526.1 2026-05-27 nodejs_compat
interface __BaseEnv_CloudflareBindings {
	DB: D1Database;
	BETTER_AUTH_URL: "https://tt-server.nmwardlow.workers.dev";
	APP_ORIGIN: "https://tt-client.nmwardlow.workers.dev";
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BETTER_AUTH_URL" | "APP_ORIGIN">> {}
}
